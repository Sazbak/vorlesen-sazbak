    ...
    <div className="flex flex-col bg-gray1 text-darkblue text-start">
      ...
      <div className="flex flex-col items-start mt-[40px] tablet:mt-[56px] mx-[24px] tablet:mx-[232px] desktop:mx-[370px]">
        ...
        <div className="text-headline-s-400 mt-[8px]">
          Marktplatz 34 3470 Kirchberg am Wagram Österreich Kontakt: Telefon:
          +49 40 36 931 125 E-Mail: post@vorlesen.app Vertretungsberichtigter
        ...
        <div className="text-headline-s-400 mt-[8px] mb-[112px]">
          ...
          gelöscht. § 3 Urheber- und Leistungsschutzrechte Die auf dieser
          ...
          schriftlicher Erlaubnis zulässig. § 4 Besondere Nutzungsbedingungen
