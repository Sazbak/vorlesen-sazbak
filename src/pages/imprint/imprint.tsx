...
function Imprint() {
  return (
    <div className="flex flex-col bg-gray1 text-darkblue text-start mx-[24px] tablet:mx-[232px] desktop:mx-[370px]">
      <Header />
      <div className="flex flex-col items-start mt-[40px]">
        <div className="text-headline-m-600">Imprint</div>
        <div className="text-paragraph-s-400 mt-[8px]">Updated 15 Jan 2023</div>
      </div>
      <div className="text-headline-xs-600 mt-[40px] desktop:mt-[48px]">
        Vorlesen Digital Media Gmbh
      </div>
      <div className="text-headline-s-400 mt-[8px]">
        Marktplatz 34 3470 Kirchberg am Wagram Österreich Kontakt: Telefon: +49
        40 36 931 125 E-Mail: post@vorlesen.app Vertretungsberichtigter
        Geschäftsführer Jan Wiechmann Registereintrag: Eingetragen im
        Handelsregister. Registergericht: Amtsgericht XXX Registernummer: XXX
      </div>
      <div className="text-headline-xs-600 mt-[32px] tablet:mt-[40px] desktop:mt-[48px]">
        Disclaimer – rechtliche Hinweise
      </div>
      <div className="text-headline-s-400 mt-[8px] mb-[112px]">
        § 1 Warnhinweis zu Inhalten Die kostenlosen und frei zugänglichen
        Inhalte dieser Webseite wurden mit größtmöglicher Sorgfalt erstellt. Der
        Anbieter dieser Webseite übernimmt jedoch keine Gewähr für die
        ...
        nicht immer die Meinung des Anbieters wieder. Allein durch den Aufruf
        ...
        insoweit fehlt es am Rechtsbindungswillen des Anbieters. § 2 Externe
        Links Diese Website enthält Verknüpfungen zu Websites Dritter ("externe
        ...
        werden jedoch derartige externe Links unverzüglich gelöscht. § 3
        Urheber- und Leistungsschutzrechte Die auf dieser Website
        ...
        kommerziellen Gebrauch ist erlaubt. Die Darstellung dieser Website in
        fremden Frames ist nur mit schriftlicher Erlaubnis zulässig. § 4
        Besondere Nutzungsbedingungen Soweit besondere Bedingungen für einzelne
        Nutzungen dieser Website von den vorgenannten Paragraphen abweichen,
        wird an entsprechender Stelle ausdrücklich darauf hingewiesen. In diesem
